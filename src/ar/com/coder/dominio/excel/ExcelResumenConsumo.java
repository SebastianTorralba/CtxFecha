 ...
 * @author sysadmin
 */
public class ExcelResumenConsumo extends ExcelGenerador {
    ...
    public ExcelResumenConsumo() {
        String[] a = {"CODIGO", "PRODUCTO", "UNIDAD","CONSUMO","USD $"};
        this.cabecera = a;
    ...
    public Integer renderizarDatos() {
        ...
        for (Iterator<?> it = getDatos().iterator(); it.hasNext();) {
            ConsumoArticulo ps = (ConsumoArticulo) it.next();
